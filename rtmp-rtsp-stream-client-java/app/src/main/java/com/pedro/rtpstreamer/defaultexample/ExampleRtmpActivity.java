...
public class ExampleRtmpActivity extends AppCompatActivity
  ...
  private String streamId = "3c40fcb4-341b-4007-a50c-63fa2e79f9b1";
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    etUrl.setText("rtmp://rtmp.livepeer.com/live/3c40-xrlv-eezt-jeiq");
    ...
    myRef.addValueEventListener(new ValueEventListener() {
      ...
      public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        Log.d("RTMP", "Value is: " + value);
      }

      @Override
      public void onCancelled(DatabaseError error) {
        // Failed to read value
        Log.w("RTMP", "Failed to read value.", error.toException());
      }
    });
  }
